  ...
  factory Story.fromJson(Map<String, dynamic> json) {
    ...
    return Story(
      ...
      category: json['category'] is Map<String, dynamic>
          ? StoryCategory.fromJson(_readMap(json['category']))
          : null,
      days: days,
    );
  }
...
class StoryCategory {
  ...
  factory StoryCategory.fromJson(Map<String, dynamic> json) {
    return StoryCategory(
      id: _readString(json['id']),
      name: _readString(json['name'], fallback: 'Stories'),
...
class DayInfo {
  const DayInfo({
    ...
    required this.shareCardQuote,
    required this.shareCardImageUrl,
  });
  ...
  final String? shareCardQuote;
  final String? shareCardImageUrl;
  ...
  factory DayInfo.fromJson(Map<String, dynamic> json) {
    return DayInfo(
      ...
      dayNumber: _readInt(json['dayNumber']),
      title: _readString(json['title'], fallback: 'Daily Katha'),
      moral: _readNullableString(json['moral']),
      tomorrowTeaser: _readNullableString(json['tomorrowTeaser']),
      shareCardQuote: _readNullableString(json['shareCardQuote']),
      shareCardImageUrl: _readNullableString(json['shareCardImageUrl']),
    );
  }
}
